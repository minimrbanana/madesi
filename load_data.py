...
def data_read_from_file(file_name=None):
    """
    load h5 file
    ...
    if file_name == None:
        ...
        hf = h5py.File("/media/yu/data/yu/dataset/madesi/IceDetection_ieckai10.h5", "r")
...
def load_data(channel, is_plot=False):
    channel_name = get_channel_name(channel)

    # load data
    ts_raw = data_read_from_file()
